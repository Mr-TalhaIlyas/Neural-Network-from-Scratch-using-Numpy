# -*- coding: utf-8 -*-
"""
Created on Tue Nov  5 17:49:38 2019
...
class neuralNetwork:
    ...
    '''
    def __init__(self, ipnodes, h1nodes, h2nodes, opnodes, bias_hid2op, bias_hid1hid2, bias_iphid1, Epsilion, BatchSize, learningrate):
...
# train the neural network
    def train(self, inputs_list, targets_list):
        ...
        self.Sdw_h2_op =  self.Sdw_h2_op + numpy.square(self.dw_h2_op)
        self.Sdw_h1_h2 =  self.Sdw_h1_h2 + numpy.square(self.dw_h1_h2)
        self.Sdw_ip_h1 =  self.Sdw_ip_h1 + numpy.square(self.dw_ip_h1)
        
        self.Sdb_h2_op =  self.Sdb_h2_op + numpy.square(self.db_h2_op)
        self.Sdb_h1_h2 =  self.Sdb_h1_h2 + numpy.square(self.db_h1_h2)
        self.Sdb_ip_h1 =  self.Sdb_ip_h1 + numpy.square(self.db_ip_h1)
...
n = neuralNetwork(input_nodes,hidden1_nodes,hidden2_nodes, output_nodes, bias_h2op, bias_h1h2, bias_iph1, epsilion, Global_Batchsize, learning_rate)
#%%
...
print('='*40)
if BS_loop == 60000:
  print("The Optimization Algorithm was Batch G.D with Adagrade")
elif BS_loop == 1:
  print("The Optimization Algorithm was Stochastic G.D with Adagrade")
else:
  print("The Optimization Algorithm was Mini_Batch G.D with Adagrade")
  
print("Time taken for 1 Epoch=",end2,'Seconds')
print("Total time taken=",end1,'Seconds')
print ("Learning Rate=",learning_rate,"\nEpsilion=",epsilion,"\nBatch Size=", BS_loop, "\nEpoch=", epochs,\
       "\nPerformance=", Performance * 100,'%')
print("NO. of nodes in both Hidden layers=", hidden2_nodes)
print('='*40)
#-------------------------------------------------------------Plotting------------------------------------------------------------------------------
